  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1 text-sm">All approved and published intelligence. Click any entry to read in full.</p>
      </div>
            ...
            <section className="space-y-4">
              ...
              <div className="space-y-3">
                {dailyBriefs.map((article) => (
                  <Card
                    key={article.id}
                    className="cursor-pointer hover:border-blue-500/30 transition-colors border-blue-500/10 bg-blue-500/[0.02]"
